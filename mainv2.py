...
excel_file = pd.ExcelFile("files/AzureAccountsReport_v3.xlsx")
...
for sheet_name in excel_file.sheet_names:
    ...
    if sheet_name == "DT_Signininfo": sheet_name = "DT"
    if sheet_name == "Averro_Signininfo": sheet_name = "Averro"
    if sheet_name == "NW_Signininfo": sheet_name = "NuWest"
...
# Create a Pandas Excel writer
writer = pd.ExcelWriter('azure_dt_data.xlsx', engine='openpyxl')
